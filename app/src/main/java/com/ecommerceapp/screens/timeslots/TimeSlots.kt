package com.ecommerceapp.screens
...
fun TimeSlotsScreen(navController: NavHostController) {
    Surface(
        ...
        Column(
            ...
            ScreenGreeting(name = stringResource(id = R.string.timeslot)) {
                navController.popBackStack()
            }

            Divider(modifier = Modifier.height(12.dp))
            AppButton(buttonname = stringResource(id = R.string.payment)) {
                navController.navigate(AppScreenName.PAYMENT.name)
            }
